        ...
        <form action="{{ route('category.store')  }}" method="post">
          ...
          <div class="card flex-fill">
            ...
            <div class="card-body py-3">
              <div class="row g-3">
                <div class="col-12">
                  <input type="text" name="title" class="form-control my-2" id="title" placeholder="{{ __('Category Title') }}" value="{{ old('title') }}" required />
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                  <input type="text" name="slug" class="form-control my-2" id="slug" placeholder="{{ __('Category Slug') }}" value="{{ old('slug') }}" />
                </div>
                <div class="col-12">
